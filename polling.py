...
class Poll(object):
    def __init__(self, poll_options):
        ...
        Initializes the poll. Converts all data to strings. Raises ValueError if no options provided.

        TODO: limit the number of poll_options, length of option strings
        '''
